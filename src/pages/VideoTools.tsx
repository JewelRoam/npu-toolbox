...
const tools = [
  { id: 'bg-remove', name: '背景移除', description: '实时视频抠像', status: 'available' as const, icon: Wand2 },
  { id: 'video-enhance', name: '画质增强', description: '视频超分辨率增强', status: 'available' as const, icon: Video },
  { id: 'video-fx', name: '视频特效', description: '实时滤镜和特效', status: 'coming' as const, icon: Wand2 },
  { id: 'video-subtitle', name: '字幕生成', description: '自动生成视频字幕', status: 'coming' as const, icon: Video },
]
...
export function VideoTools() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">视频工具</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1">AI 驱动的视频处理和增强</p>
      </div>
